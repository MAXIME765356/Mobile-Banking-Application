...
List<BankingQuesAnsModel> bankingQuestionList() {
  ...
  var list2 = BankingQuesAnsModel(
      "Money return when you go shopping with credit card of Unics PLC ?");
  list.add(list2);
  ...
  var list4 = BankingQuesAnsModel(
      " Unics PLC  give a giftbox for new customers who create account ?");
  list.add(list4);
...
List<BankingCardModel> bankingCardList() {
  ...
  var list1 = BankingCardModel(
      name: "Kadji", bank: "The Same Bank", rs: "12,500");
  list.add(list1);

  var list2 =
      BankingCardModel(name: "fotso laura", bank: "Union Bank", rs: "18,000");
  list.add(list2);

  var list3 = BankingCardModel(
      name: "cho jonathan", bank: "Unitied States Bank", rs: "50,000");
  list.add(list3);
...
List<BankingPaymentHistoryModel> bankingHistoryList1() {
  ...
  var list1 = BankingPaymentHistoryModel(
      title: "Payment Invoice # 7783", rs: "-\20000 FCFA");
  list.add(list1);

  var list2 = BankingPaymentHistoryModel(
      title: "Payment Invoice S1244", rs: "-\19000 FCFA");
  list.add(list2);
...
List<BankingHomeModel> bankingHomeList1() {
  ...
  var list1 = BankingHomeModel(
      title: "Default Account", color: Banking_BalanceColor, bal: "+\50000 FCFA");
  list.add(list1);

  var list2 = BankingHomeModel(
      title: "Adams ", color: Banking_Primary, bal: "-\20000 FCFA");
  list.add(list2);
...
List<BankingLocationModel> bankingLocationList() {
  ...
  var list1 = BankingLocationModel(location: "Branch YMC", m: "800m");
  list.add(list1);

  var list2 = BankingLocationModel(location: "Branch Head Office", m: "600m");
  list.add(list2);

  var list3 = BankingLocationModel(location: "Branch Buea", m: "600m");
  list.add(list3);

  var list4 = BankingLocationModel(location: "Branch Deido", m: "2.5km");
  list.add(list4);
